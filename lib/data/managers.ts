...
export const managers: Manager[] = [
  {
    ...
    name: 'Emmet Burns',
    joined: 2020,
    bio: 'The Commissioner. The man who built MAC 12 from the ground up, sets the rules, runs the app, and who conveniently happens to sit atop the all-time table. Whether that is a testament to his skill or to the perks of being the one who designs the system is a question the group chat will never stop asking.\n\nSix seasons, six playoff appearances. The only manager in league history with a perfect postseason streak. Never finished below sixth. Never visited the Wall of Shame. Never changed his team name. Consistency is the brand, and the brand is unshakeable.\n\nOne of the most active managers on the waiver wire, Burns is always tinkering, always looking for an edge. The trade offers are relentless and unsolicited. He has earned the dodgy dealer reputation, and no amount of podium finishes will wash it off.\n\nFour podiums in six seasons. Bronze in 2020, bronze in 2022, gold in 2023 with a dominant 11-3 run, and bronze again in 2025. One championship in six years of running the entire operation. The commissioner was always lurking near the top, and the 2023 title finally gave him the hardware to match the authority.\n\nJudge, jury, and champion. Welcome to his league.',
  },
  {
